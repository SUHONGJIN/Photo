...
public class OtherPhotoAdapter extends RecyclerView.Adapter<OtherPhotoAdapter.ViewHolder> {

    private List<OtherPhoto> photoList = new ArrayList<>();
    private Context context;

    public OtherPhotoAdapter(Context context, List<OtherPhoto> otherPhoto) {
        this.photoList = otherPhoto;
