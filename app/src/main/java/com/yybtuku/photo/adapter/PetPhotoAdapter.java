...
public class PetPhotoAdapter extends RecyclerView.Adapter<PetPhotoAdapter.ViewHolder> {
    private List<PetPhoto> photoList = new ArrayList<>();
    private Context context;

    public PetPhotoAdapter(Context context, List<PetPhoto> petPhotos) {
        this.photoList = petPhotos;
