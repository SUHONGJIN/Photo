package com.yybtuku.photo.adapter;
...
import com.yybtuku.photo.ui.activity.ShowImageActivity;
...
public class PeoplePhotoAdapter extends RecyclerView.Adapter<PeoplePhotoAdapter.ViewHolder> {
    private List<PeoplePhoto> photoList = new ArrayList<>();
    private Context context;

    public PeoplePhotoAdapter(Context context, List<PeoplePhoto> peoplePhoto) {
        this.photoList = peoplePhoto;
