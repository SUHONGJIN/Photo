...
public class PhonePhotoAdapter extends RecyclerView.Adapter<PhonePhotoAdapter.ViewHolder> {
    private List<PhonePhoto> photoList = new ArrayList<>();
    private Context context;

    public PhonePhotoAdapter(Context context, List<PhonePhoto> phonePhoto) {
        this.photoList = phonePhoto;
